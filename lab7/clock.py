...
clock_face = pygame.image.load("lab7/clock.png").convert_alpha()
minute_hand_img = pygame.image.load("lab7/min_hand.png").convert_alpha()
second_hand_img = pygame.image.load("lab7/sec_hand.png").convert_alpha()
